...
- 報告 ID：`sdd-ai-robust-requirements-20260531-v10`
- 版本：`10.0.0`
- 產生時間：`2026-05-31T16:30:12Z`
...
- [完整機器可讀來源 metadata](sdd-ai-robust-requirements-20260531-v10.json)
- 個別來源的原始 snapshot、摘要與 metadata 請由來源總目錄進入。
